...
options.register('tarBall', '', VarParsing.VarParsing.multiplicity.singleton,VarParsing.VarParsing.varType.string,"name of tar ball")
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/TOP-RunIISummer19UL17wmLHEGEN-00055-fragment.py nevts'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TOP_nano.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TOP_inLHE.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    ...
    # args = cms.vstring('st_tch_top_halfchain_ctW_0p02_ctWI_m3p67_cpQ3_4p1_cQq13_3p51_cQq83_m7p21_slc7_amd64_gcc700_CMSSW_10_2_17_tarball.tar.xz'), # ../st_tch_top_madgraph_slc7_amd64_gcc700_CMSSW_10_2_17_tarball.tar.xz'), #'../st_tch_top_slc7_amd64_gcc700_CMSSW_10_2_17_tarball.tar.xz'),
