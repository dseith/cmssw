...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    # fileName = cms.untracked.string('file:/ceph/dseith/mc_gen/TOP_gen_top.root'),
    fileName = cms.untracked.string('TOP_gen_top.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TOP_gen_top_inLHE.root'),
