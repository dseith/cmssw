...
jetTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(P4Vars,
        ...
        chMultiplicity = Var("chargedMultiplicity()", float, doc="charged Multiplicity"),
        neMultiplicity = Var("neutralMultiplicity()", float, doc="neutral Multiplicity"),
...
bjetNN= cms.EDProducer("BJetEnergyRegressionMVA",
    ...
    Jet_chMultiplicity = cms.string("chargedMultiplicity()"),
    Jet_neMultiplicity = cms.string("neutralMultiplicity()"),
